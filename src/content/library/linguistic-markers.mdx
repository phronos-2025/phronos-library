...
title: "Linguistic Markers of Cognition"
...
|--------|--------------|---------|
| **Olson et al. 2021** | DAT validation (r = 0.40 with AUT, r = 0.28 with RAT) | Supports H1.8 for 10-word unconstrained task. INS-001 uses 2–5 words under constraint; transfer validity untested. See [MTH-002.1 §3.3](/methods/semantic-association-metrics/spread-fidelity-scoring/#3-spread). |
...
| **Auguste et al. 2017** | Embeddings predict priming RT | Partially supports H1.7 at population level. Individual-difference validity untested. See [MTH-002.1 §4.3](/methods/semantic-association-metrics/spread-fidelity-scoring/#4-dat-calibration) documenting 20.7-point model-dependent scoring effects. |
